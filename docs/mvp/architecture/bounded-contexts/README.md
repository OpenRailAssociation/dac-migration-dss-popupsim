...
### Core Contexts
1. **[Infrastructure Context](infrastructure-context.md)** - Gleise, Weichen, Topologie
2. **[Workshop Context](workshop-context.md)** - DAK-Umrüstung, Stationen
3. **[Resource Management Context](resource-management-context.md)** - Lokomotiven, Personal

### Supporting Contexts
4. **[Configuration Context](configuration-context.md)** - Datenimport, Validierung, Templates
5. **[Simulation Control Context](simulation-control-context.md)** - Simulationssteuerung, Orchestrierung
6. **[Analytics Context](analytics-context.md)** - **NEU** - KPI-Berechnung, Metriken, Reporting

### Generic Contexts
7. **[Train Operations Context](train-operations-context.md)** - Zugankünfte, Rangieroperationen
