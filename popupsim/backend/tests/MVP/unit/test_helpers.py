...
from popupsim.backend.src.MVP.configuration.application.dtos.locomotive_input_dto import (
    LocomotiveInputDTO,
)
from popupsim.backend.src.MVP.configuration.application.dtos.route_input_dto import (
    RouteInputDTO,
)
from popupsim.backend.src.MVP.configuration.application.dtos.workshop_input_dto import (
    WorkshopInputDTO,
)
from popupsim.backend.src.MVP.configuration.domain.models.process_times import (
    ProcessTimes,
)
...
def create_minimal_scenario_with_dtos(
    ...
    wagons = [
        Wagon(id=f"W{i:02d}", length=10.0, needs_retrofit=True, is_loaded=False)
