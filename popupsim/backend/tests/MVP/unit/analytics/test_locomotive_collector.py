...
from popupsim.backend.src.MVP.analytics.domain.collectors.locomotive_collector import (
    LocomotiveCollector,
)
from popupsim.backend.src.MVP.analytics.domain.events.locomotive_events import (
...
def test_multiple_locomotives() -> None:
    ...
    events = [
        ...
        LocomotiveStatusChangeEvent(
            EventId.generate(),
            Timestamp.from_simulation_time(10.0),
            "analytics",
            locomotive_id="L001",
            status="moving",
        ),
