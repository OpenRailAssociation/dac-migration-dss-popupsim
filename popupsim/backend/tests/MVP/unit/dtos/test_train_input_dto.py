...
from popupsim.backend.src.MVP.configuration.application.dtos.train_input_dto import (
    TrainInputDTO,
)
from popupsim.backend.src.MVP.configuration.application.dtos.wagon_input_dto import (
    WagonInputDTO,
)
...
class TestTrainInputDTO:
    ...
    def test_valid_train_dto(self) -> None:
        ...
        wagon = WagonInputDTO(
            id="W001", length=15.5, is_loaded=False, needs_retrofit=True
        )
        dto = TrainInputDTO(
            train_id="T001",
