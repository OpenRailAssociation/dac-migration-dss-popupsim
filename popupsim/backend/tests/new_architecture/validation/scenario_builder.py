...
from contexts.configuration.application.dtos.locomotive_input_dto import (
    LocomotiveInputDTO,  # noqa: E402
)
from contexts.configuration.application.dtos.route_input_dto import (
    RouteInputDTO,  # noqa: E402
)
from contexts.configuration.application.dtos.track_input_dto import (
    TrackInputDTO,  # noqa: E402
)
from contexts.configuration.application.dtos.topology_input_dto import (
    TopologyInputDTO,  # noqa: E402
)
from contexts.configuration.application.dtos.wagon_input_dto import (
    WagonInputDTO,  # noqa: E402
)
from contexts.configuration.application.dtos.workshop_input_dto import (
    WorkshopInputDTO,  # noqa: E402
)
from contexts.configuration.domain.models.process_times import (
    ProcessTimes,  # noqa: E402
)
from contexts.configuration.domain.models.scenario import Scenario  # noqa: E402
