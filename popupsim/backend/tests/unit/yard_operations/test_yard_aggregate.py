...
from yard_operations.domain.services.yard_coordinator import YardCoordinator
...
def test_yard_add_area() -> None:
    ...
    area = YardArea(area_id='classification_1', area_type=AreaType.CLASSIFICATION, tracks=tracks)
...
def test_yard_area_has_capacity() -> None:
    ...
    area_without_tracks = YardArea(area_id='area_2', area_type=AreaType.PARKING, tracks=[])
