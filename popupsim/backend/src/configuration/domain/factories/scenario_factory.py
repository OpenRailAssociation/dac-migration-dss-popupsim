...
class ScenarioFactory:
    ...
    def from_dto(dto: ScenarioInputDTO) -> Scenario:
        ...
        return Scenario(
            ...
            track_selection_strategy=TrackSelectionStrategy(dto.track_selection_strategy or 'least_occupied'),
            retrofit_selection_strategy=TrackSelectionStrategy(dto.retrofit_selection_strategy or 'least_occupied'),
            loco_delivery_strategy=LocoDeliveryStrategy(dto.loco_delivery_strategy or 'return_to_parking'),
            trains=dto.trains,
