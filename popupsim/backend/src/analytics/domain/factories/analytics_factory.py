...
from ..events.simulation_events import (
    WagonDeliveredEvent,
    WagonRetrofittedEvent,
    WagonRejectedEvent,
)
from ..models.kpi_result import KPIResult, ThroughputKPI, UtilizationKPI, BottleneckInfo
...
class AnalyticsFactory:
    ...
    @staticmethod
    def create_simulation_started_event(scenario: Scenario) -> DomainEvent:
    ...
    def create_simulation_completed_event(
        scenario_id: str, total_processed: int, total_rejected: int
    ) -> DomainEvent:
    ...
    def create_kpi_result(
        ...
        utilization: list[UtilizationKPI],
