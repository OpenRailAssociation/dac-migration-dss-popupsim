...
class ProcessTimes(BaseModel):
    ...
    wagon_coupling_time: float = Field(
        default=1.0,
        ge=0,
        description='Time in minutes to couple one wagon'
    )
    wagon_decoupling_time: float = Field(
        default=1.0,
        ge=0,
        description='Time in minutes to decouple one wagon'
    )
    wagon_retrofit_time: float = Field(
        default=60.0,
        ge=0,
        description='Time in minutes to retrofit one wagon at a station'
    )
