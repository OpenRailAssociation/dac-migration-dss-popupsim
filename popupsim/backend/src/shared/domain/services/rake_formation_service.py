...
from shared.domain.services.rake_formation_strategy import (
    FixedSizeStrategy,
    RakeFormationStrategy,
    TrackCapacityStrategy,
    WorkshopCapacityStrategy,
)
...
class RakeFormationService:
    ...
    def form_rakes(
        self, wagons: list[Wagon], strategy: str, constraints: dict[str, any]
    ) -> list[Rake]:
    ...
    def form_collection_rakes(
        self, wagons: list[Wagon], track_capacity: float
    ) -> list[Rake]:
    ...
    def form_retrofit_rakes(
        self, wagons: list[Wagon], retrofit_track_capacity: float
    ) -> list[Rake]:
    ...
    def form_transport_rake(
        self, wagons: list[Wagon], from_track: str, to_track: str
    ) -> Rake:
