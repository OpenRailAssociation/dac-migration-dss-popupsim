...
from shared.validation.validators.feasibility_validator import (
    FeasibilityValidator,
)
from shared.validation.validators.integrity_validator import (
    IntegrityValidator,
)
from shared.validation.validators.semantic_validator import (
    SemanticValidator,
)
from shared.validation.validators.syntax_validator import (
    SyntaxValidator,
)
...
class ValidationPipeline:
    ...
    def validate_layer(
        self, scenario: Scenario, category: ValidationCategory
    ) -> ValidationResult:
        ...
        msg = f"Unknown validation category: {category}"
