...
from MVP.shunting_operations.application.shunting_service import (
...
from MVP.workshop_operations.application.services.locomotive_service import (
    LocomotiveService,
)
from MVP.workshop_operations.domain.entities.locomotive import (
    Locomotive,
)
from MVP.workshop_operations.domain.services.locomotive_operations import (
    LocomotiveStateManager,
)
from MVP.workshop_operations.infrastructure.resources.resource_pool import (
    ResourcePool,
    Trackable,
)
