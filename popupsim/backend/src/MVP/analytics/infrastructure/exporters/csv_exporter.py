...
class CSVExporter:
    ...
    def export_time_series(
        self, metrics: dict[str, list[dict[str, Any]]], output_dir: Path
    ) -> None:
    ...
    def _export_utilization(self, kpi_result: KPIResult, output_dir: Path) -> None:
        ...
        data = {
            ...
            "average_utilization_percent": [
                u.average_utilization_percent for u in kpi_result.utilization
            ],
            "peak_utilization_percent": [
                u.peak_utilization_percent for u in kpi_result.utilization
            ],
    ...
    def _export_bottlenecks(self, kpi_result: KPIResult, output_dir: Path) -> None:
        ...
        data = {
            ...
            "impact_wagons_per_hour": [
                b.impact_wagons_per_hour for b in kpi_result.bottlenecks
            ],
        }
        df = pd.DataFrame(data)
