...
from MVP.analytics.domain.exceptions import KPICalculationError
from MVP.analytics.domain.models.bottleneck_config import (
    BottleneckConfig,
)
from MVP.analytics.domain.models.kpi_result import KPIResult
from MVP.analytics.domain.models.simulation_data import (
    ContextData,
    SimulationData,
)
from MVP.analytics.domain.services.kpi_calculator import (
    KPICalculator,
)
...
class AsyncAnalyticsService:
    ...
    async def calculate_kpis_async(
        ...
        try:
            ...
            msg = f"Async KPI calculation failed for scenario {simulation_data.scenario.id}"
