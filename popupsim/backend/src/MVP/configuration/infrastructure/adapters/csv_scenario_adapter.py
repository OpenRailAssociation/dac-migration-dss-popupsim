...
class CsvScenarioAdapter(ScenarioPort):
    ...
    def _load_csv_data(self, source: Path) -> ScenarioInputDTO:
        ...
        try:
            ...
            msg = "pandas required for CSV processing"
        ...
        if tracks_df.empty:
            msg = "tracks.csv cannot be empty"
        ...
        return ScenarioInputDTO(
            ...
            retrofit_selection_strategy=scenario_data.get(
    ...
    def _process_workshops(self, workshops_df: Any) -> list[WorkshopInputDTO]:
        ...
        return [
            ...
            for row in workshops_df.to_dict("records")
        ]
