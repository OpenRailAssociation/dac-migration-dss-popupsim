...
from MVP.analytics.application.async_analytics_service import (
    AsyncAnalyticsService,
)
from MVP.analytics.domain.models.simulation_data import (
    ContextData,
    SimulationData,
)
from MVP.analytics.infrastructure.exporters.csv_exporter import (
    CSVExporter,
)
from MVP.analytics.infrastructure.visualization.matplotlib_visualizer import (
    Visualizer,
)
from MVP.configuration.application.scenario_builder import (
    ScenarioBuilder,
)
from MVP.simulation.application.simulation_orchestrator import (
...
def run(
    ...
    typer.echo("✅ MVP simulation completed!")
