...
from MVP.analytics.application.metrics_aggregator import (
    SimulationMetrics,
)
from MVP.analytics.domain.collectors.locomotive_collector import (
    LocomotiveCollector,
)
from MVP.analytics.domain.collectors.wagon_collector import (
    WagonCollector,
)
from MVP.analytics.domain.collectors.wagon_movement_collector import (
    WagonMovementCollector,
)
from MVP.analytics.domain.events.location_events import (
...
from MVP.popup_retrofit.application.popup_context import (
    PopUpRetrofitContext,
)
from MVP.shunting_operations.application.shunting_context import (
    ShuntingOperationsContext,
)
from MVP.workshop_operations.application.coordinators.train_arrival_coordinator import (
    TrainArrivalCoordinator,
)
from MVP.workshop_operations.application.coordinators.wagon_pickup_coordinator import (
    WagonPickupCoordinator,
)
from MVP.workshop_operations.application.coordinators.workshop_processing_coordinator import (
    WorkshopProcessingCoordinator,
)
from MVP.workshop_operations.application.factories.entity_factory import (
    EntityFactory,
)
...
from MVP.workshop_operations.domain.services.scenario_domain_validator import (
...
from MVP.workshop_operations.domain.services.workshop_operations import (
    WorkshopDistributor,
)
...
from MVP.yard_operations.application.yard_operations_config import (
    YardOperationsConfig,
)
from MVP.yard_operations.application.yard_operations_context import (
    YardOperationsContext,
)
from MVP.yard_operations.infrastructure.parking_coordinator import (
    ParkingSimPyCoordinator,
)
...
class WorkshopOperationsContext:  # pylint: disable=too-many-instance-attributes
    ...
    def __init__(
        ...
        if not domain_result.is_valid:
            ...
            msg = f"Domain validation failed: {'\n'.join(error_messages)}"
...
) -> Generator[Any, Any, Any]:  # pylint: disable=too-many-locals
