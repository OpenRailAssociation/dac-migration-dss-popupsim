...
from MVP.simulation.infrastructure.events.event_wrapper import (
    EventWrapper,
)
...
class SimPyEngineAdapter(SimulationEnginePort):
    ...
    def current_timestamp(self) -> "Timestamp":
        ...
        from analytics.domain.value_objects.timestamp import Timestamp as TS

        return TS.from_ticks(self._env.now)
