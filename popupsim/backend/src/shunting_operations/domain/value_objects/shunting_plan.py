...
class ShuntingPlan:
    ...
    @classmethod
    def create(cls, plan_id: str, locomotive_id: str, steps: list[ShuntingStep]) -> 'ShuntingPlan':
        ...
        ShuntingPlanValidator.validate_locomotive_consistency(locomotive_id, step_tuples)
