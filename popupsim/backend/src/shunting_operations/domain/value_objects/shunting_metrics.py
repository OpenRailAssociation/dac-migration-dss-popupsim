...
class ShuntingMetrics(BaseModel):
    ...
    total_coupling_operations: int = Field(default=0, description='Total coupling operations')
    total_active_time: float = Field(default=0.0, description='Total active time (minutes)')
