...
class PopUpMetrics(BaseModel):
    ...
    successful_retrofits: int = Field(default=0, description='Number of successful retrofits')
    ...
    def wagons_per_hour(self) -> float:
        ...
        if self.total_processing_time == 0:
            return 0.0
        return (self.total_wagons_processed * SIMULATION_TIME_UNIT_SECONDS) / self.total_processing_time
