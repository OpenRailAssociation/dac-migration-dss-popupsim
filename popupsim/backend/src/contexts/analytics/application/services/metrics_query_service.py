...
from contexts.analytics.domain.value_objects.metrics_snapshot import BottleneckDetection
from contexts.analytics.domain.value_objects.metrics_snapshot import LocomotiveUtilization
from contexts.analytics.domain.value_objects.metrics_snapshot import TrackCapacitySnapshot
from contexts.analytics.domain.value_objects.metrics_snapshot import TrainArrivalMetrics
from contexts.analytics.domain.value_objects.metrics_snapshot import WagonMetrics
from contexts.analytics.domain.value_objects.metrics_snapshot import WorkshopMetrics
...
class MetricsQueryService:
    ...
    def get_wagon_metrics(self) -> WagonMetrics:
        ...
        return WagonMetrics(
            ...
            on_retrofitted_track_count=self._stats.get('wagons_on_retrofitted_track', 0),
        )
    ...
    def get_all_locomotive_utilizations(self) -> dict[str, LocomotiveUtilization]:
        ...
        return {loco_id: self.get_locomotive_utilization(loco_id) for loco_id in locomotives}
    ...
    def get_all_workshop_metrics(self) -> dict[str, WorkshopMetrics]:
        ...
        return {workshop_id: self.get_workshop_metrics(workshop_id) for workshop_id in workshops}

    def get_track_capacity(self, track_id: str, timestamp: float) -> TrackCapacitySnapshot:
