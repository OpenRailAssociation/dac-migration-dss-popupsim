...
class ParkingCoordinator:  # pylint: disable=too-many-instance-attributes,too-few-public-methods
    ...
    def _parking_process_opportunistic(self, retrofitted_track_id: str) -> Generator[Any, Any]:
        ...
        while True:
            ...
            logger.info('t=%.1f: WAGON[%s] → Retrieved from retrofitted track %s', 
                       self.config.env.now, first_wagon.id, retrofitted_track_id)
    ...
    def _parking_process_smart_accumulation(self, retrofitted_track_id: str) -> Generator[Any, Any]:
        ...
        while True:
            ...
            logger.info('t=%.1f: BATCH[%s] → Accumulated %d wagons from %s', 
                       self.config.env.now, wagon_ids, len(wagons), retrofitted_track_id)
    ...
    def _accumulate_to_threshold(self, first_wagon: Wagon, queue: Any, track_capacity: float) -> Generator[Any, Any, list[Wagon]]:
    ...
    def _process_wagon_batch_with_wagons(self, wagons: list[Wagon], parking_track: Any, retrofitted_track_id: str) -> Generator[Any, Any]:
    ...
    def _process_wagon_batch(self, first_wagon: Wagon, parking_track: Any, retrofitted_track_id: str, queue: Any) -> Generator[Any, Any]:
    ...
    def _transport_to_parking_with_batch(
        self, loco: Any, batch_aggregate: Any, batch_id: str, parking_track_id: str, retrofitted_track_id: str
    ) -> Generator[Any, Any]:
        ...
        train = self.config.train_service.form_train(loco, batch_aggregate, retrofitted_track_id, parking_track_id, route_type)
    ...
    def _transport_batch_aggregate(self, batch_aggregate: Any, parking_track_id: str, retrofitted_track_id: str) -> Generator[Any, Any]:
        ...
        try:
            ...
            yield from self._transport_to_parking_with_batch(loco, batch_aggregate, batch_id, parking_track_id, retrofitted_track_id)
