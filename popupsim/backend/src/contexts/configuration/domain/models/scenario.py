...
class Scenario(BaseModel):
    ...
    track_selection_strategy: TrackSelectionStrategy = (
        TrackSelectionStrategy.LEAST_OCCUPIED
    )
    retrofit_selection_strategy: TrackSelectionStrategy = (
        TrackSelectionStrategy.LEAST_OCCUPIED
    )
    workshop_selection_strategy: TrackSelectionStrategy = (
        TrackSelectionStrategy.ROUND_ROBIN
    )
    parking_selection_strategy: TrackSelectionStrategy = (
        TrackSelectionStrategy.LEAST_OCCUPIED
    )
    loco_delivery_strategy: LocoDeliveryStrategy = (
        LocoDeliveryStrategy.RETURN_TO_PARKING
    )
