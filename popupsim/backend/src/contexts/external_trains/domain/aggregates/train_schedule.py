...
class TrainSchedule:
    ...
    def process_arrival(
        self, train_id: TrainId, arrival_time: float
    ) -> TrainArrivedEvent:
        ...
        return TrainArrivedEvent(
            train_id=train_id, wagons=train.wagons, arrival_metrics=metrics
        )

    def process_departure(
        self, train_id: TrainId, departure_time: float
    ) -> TrainDepartedEvent:
