...
from yard_operations.domain.entities.yard_area import AreaType, YardArea
...
class YardCoordinator:
    ...
    def route_wagon_to_area(
        self, wagon: Wagon, decision: ClassificationDecision
    ) -> YardArea | None:  # noqa: ARG002
