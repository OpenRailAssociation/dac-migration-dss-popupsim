...
class ScenarioBuilder:
    ...
    def __load_locomotives(self) -> None:
        ...
        if not locomotives_file:
            raise BuilderError(
                "Missing locomotives file reference in scenario configuration"
            )
        ...
        try:
            ...
            raise BuilderError(
                f"Invalid JSON format in {locomotives_path}: {e!s}"
            ) from e
        except Exception as e:
            raise BuilderError(
                f"Failed to load locomotives from {locomotives_path}: {e!s}"
            ) from e
    ...
    def __load_routes(self, scenario_dto: ScenarioInputDTO) -> None:
        ...
        try:
            ...
            raise BuilderError(
                f"Failed to load routes from {routes_path}: {e!s}"
            ) from e
    ...
    def __load_topology(self) -> None:
        ...
        if not topology_file:
            raise BuilderError(
                "Missing topology file reference in scenario configuration"
            )
        ...
        try:
            ...
            raise BuilderError(
                f"Failed to load topology from {topology_path}: {e!s}"
            ) from e
    ...
    def __load_process_times(self) -> None:
        ...
        if not process_times_file:
            raise BuilderError(
                "Missing process_times file reference in scenario configuration"
            )
        ...
        try:
            ...
            raise BuilderError(
                f"Failed to load process times from {process_times_path}: {e!s}"
            ) from e
    ...
    def __load_tracks(self, scenario_dto: ScenarioInputDTO) -> None:
        ...
        try:
            ...
            raise BuilderError(
                f"Failed to load tracks from {tracks_path}: {e!s}"
            ) from e
    ...
    def __load_trains(self, scenario_dto: ScenarioInputDTO) -> None:  # pylint: disable=too-many-locals
        ...
        try:
            ...
            raise BuilderError(
                f"Failed to load trains from {trains_path}: {e!s}"
            ) from e
    ...
    def __load_workshops(self) -> None:
        ...
        if not workshops_file:
            raise BuilderError(
                "Missing workshops file reference in scenario configuration"
            )
        ...
        try:
            ...
            raise BuilderError(
                f"Failed to load workshops from {workshops_path}: {e!s}"
            ) from e
